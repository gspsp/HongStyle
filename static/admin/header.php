...
<html class="no-js">
    <head>
		...
		var UserPic="<?php $email =$user->mail; if($email){if(strpos($email,'@qq.com') !==false){$email=str_replace('@qq.com','',$email);echo '//q1.qlogo.cn/g?b=qq&nk='.$email.'&';}else{$email= md5($email);echo '//secure.gravatar.com/avatar/'.$email.'?';}}else{echo '//secure.gravatar.com/avatar/null?';} ?>";
